...
export const metadata: Metadata = {
  title: "Software Dental en Colombia | Dentiqa - Gestion Integral para Clinicas",
  description:
    "Software odontologico lider en Colombia. Agenda inteligente, historia clinica digital, odontograma, WhatsApp con IA. Compatible con flujos EPS. Prueba gratis 14 dias.",
  keywords: [
    "software dental Colombia",
    "software odontologico Colombia",
    "turnos dentista Colombia",
    "sistema de turnos odontologia Colombia",
    "historia clinica dental Colombia",
    "odontograma digital Colombia",
    "software para clinicas dentales Colombia",
    "WhatsApp dentista Colombia",
    "agenda dental Colombia",
    "gestion clinica dental Colombia",
    "software dental EPS Colombia",
  ],
  ...
  openGraph: {
    type: "website",
    locale: "es_CO",
    url: "https://dentiqa.app/co",
    siteName: "Dentiqa",
    title: "Software Dental en Colombia | Dentiqa",
    description:
      "El software dental lider para clinicas en Colombia. WhatsApp con IA, agenda, odontograma y mas. Precios en pesos colombianos.",
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
        height: 630,
        alt: "Dentiqa - Software Dental para Colombia",
      },
    ],
  },
  twitter: {
    ...
    title: "Software Dental en Colombia | Dentiqa",
    description:
      "Plataforma todo-en-uno para clinicas dentales en Colombia con WhatsApp IA, agenda inteligente y mas.",
    images: ["/opengraph-image"],
  },
  robots: { index: true, follow: true },
  alternates: { canonical: "https://dentiqa.app/co" },
};
...
const softwareJsonLd = {
  ...
  operatingSystem: "Web",
  description:
    "Software todo-en-uno para clinicas dentales en Colombia con inteligencia artificial, WhatsApp integrado, agenda, historia clinica digital y odontograma.",
  url: "https://dentiqa.app/co",
  author: {
    "@type": "Organization",
    name: "Violet Wave IA",
...
const localBusinessJsonLd = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  name: "Dentiqa - Software Dental Colombia",
  description:
    "Proveedor de software de gestion integral para clinicas dentales en Colombia.",
  url: "https://dentiqa.app/co",
  areaServed: {
    "@type": "Country",
    name: "Colombia",
...
const features = [
  {
    ...
    description:
      "Gestiona citas con vista semanal y diaria, multi-dentista, drag-and-drop y sincronizacion con Google Calendar. Zona horaria Colombia (GMT-5) configurada por defecto.",
  },
  {
    icon: Bot,
    title: "Chatbot WhatsApp con IA",
    description:
      "Tu asistente virtual atiende pacientes 24/7 por WhatsApp. Agenda citas, responde consultas y deriva a recepcion cuando es necesario. Ideal para el mercado colombiano.",
  },
  {
    icon: ClipboardList,
        ...
        <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-violet-700 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 text-center">
            ...
            <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto mb-10">
              ...
              inteligente e historia clinica digital. Compatible con flujos de
              EPS. Precios en pesos colombianos.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/5492612312567?text=Hola%2C%20quiero%20info%20sobre%20Dentiqa%20para%20Colombia"
            ...
            <p className="mt-6 text-sm text-blue-200">
              Sin tarjeta de credito -- Zona horaria Colombia (GMT-5) -- Soporte en espanol
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                WhatsApp: el canal #1 en Colombia
              </h2>
              <p className="text-lg text-gray-600">
                Mas del 90% de los colombianos usan WhatsApp a diario. Con
                Dentiqa, tu clinica cuenta con un chatbot con inteligencia
        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-center text-sm text-gray-500 mt-8">
              Precios aproximados en COP. El monto exacto se calcula al momento
        ...
        <section className="bg-gray-50 py-16 sm:py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">
              Clinicas en Colombia ya confian en Dentiqa
            </h2>
            <blockquote className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              <p className="text-lg text-gray-700 italic mb-4">
                &ldquo;Con Dentiqa logramos automatizar la atencion por WhatsApp
                y reducir las inasistencias un 35%. La historia clinica digital
                y el odontograma son excelentes. Muy recomendable para clinicas
                en Colombia.&rdquo;
              </p>
              <footer className="text-sm text-gray-500">
                -- Clinica dental en Bogota
              </footer>
            </blockquote>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-violet-600 py-16 sm:py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-xl mx-auto">
              Unete a las clinicas colombianas que ya gestionan todo desde una
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            <div>
              ...
              <p className="text-sm max-w-md">
                ...
                en Colombia. Agenda, historia clinica, WhatsApp con IA y mas.
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
            <p>
              ...
              derechos reservados. Software dental para clinicas en Colombia.
            </p>
          </div>
        </div>
      </footer>
